...
/* Spinitron API calls*/
// fetch method for spinitron api
...
// get all spinitron personas
export async function getPersonas() {
  const url = SPINITRON_API_URL + "/personas?count=200"
  const data = await fetchSpinAPI(url)
  return data
}
// get spinitron persona by a persona id
...
/* WordPress Graphql API calls*/
// fetch method for wordpress graphql
