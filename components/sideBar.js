...
data = data.data
  return (
    <div className="border-black border-2 p-3">
      ...
      <div className="text-xl">A service of <a className="underline" target="_blank" href="https://carleton.edu">Carleton College</a> <a className="underline" target="_blank" href="https://www.ci.northfield.mn.us/">Northfield, MN</a>. Call the studio at <a className="underline" target="_blank" href="tel:5072224127">507-222-4127</a> and chat with our djs <a className="underline" target="_blank" href="https://minnit.chat/KRLX">here</a>.</div>
      The time is <Clock />
      <div><Link as={`/`} href="/">
        <a
